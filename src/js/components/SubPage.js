      ...
      <Box>
        ...
        <Hero size='large' backgroundImage='/img/marquee.jpg' colorIndex='light-1'>
          <Card
            ...
            size='large'
            link={
              <Anchor href='/detail' primary={true} label='Learn More' />
            } />
        </Hero>
        ...
        <Hero size='large'
          backgroundImage='/img/section-1.jpg'
          colorIndex='light-1'
          justify='start'>
          <Card
            heading={
            ...
            description='HPE can help you benefit now from your right mix of cloud'
            label='label'
            size='large' link={<Anchor href='/detail' primary={true} label='Learn More' />} />
        </Hero>
        <Hero size='large' backgroundImage='/img/section-2.jpg' colorIndex='light-1'>
          <Card
            ...
            label='label'
            size='large'
            link={<Anchor href='/detail' primary={true} label='Learn More' />} />
        </Hero>
