...
export default class DetailsPage extends Component {
  render() {
    return (
      <Box>
        <Header />
        <Hero size="large" backgroundImage="/img/marquee1.jpg" colorIndex="grey-1"
          justify="start">
          <Card
            heading={
              <Heading strong={true}>
        ...
        <Section pad="none" align="center">
          <Box full="horizontal">
            <Image full src="/img/section-11.jpg" />
          </Box>
          <Box
            direction="row"
            size={{width: 'xxlarge'}}
        ...
        <Hero size="large" backgroundImage="/img/section-21.jpg" colorIndex="grey-1"
          justify="center">
          <Card
            textAlign="center"
            heading={
